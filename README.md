...
**biostatistical theory → scientific literature → practical implementation in R**

Rather than emphasizing mathematical formalism, the book prioritizes **intuition, interpretation, and practical reasoning**.

## Contributing

The complete LaTeX source, figures, references, and R code are available in this repository.
